...
BASE_PATH = '../data' if osp.exists('../data') else 'data'

from proj4_code.projection_matrix import (
    projection,
    objective_func,
...
def test_objective_func():
    ...
    pts2d_path = osp.join(BASE_PATH, 'pts2d-pic_b.txt')
    pts3d_path = osp.join(BASE_PATH, 'pts3d.txt')
